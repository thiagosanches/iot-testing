# iot-testing
My little adventure in the IoT world, the idea is to maintain an unique central that controls everything through my Raspberry Pi A+. I'm using the serial communication to fetch the data that I need.
...
The python script is the responsible to read the data from Arduino through the serial communication in the way that Prometheus can understand it. TODO: improve its performance and avoid collecting the data all the time.
